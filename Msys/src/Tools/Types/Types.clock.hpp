...
template <typename T>
concept Clocks = std::same_as<T, Clock::HClock>
    || std::same_as<T, Clock::SClock>;
...
// Durations
template <typename T>
concept Duration = std::same_as<T, Units::ns>
    || std::same_as<T, Units::ms>
    || std::same_as<T, Units::us>
    || std::same_as<T, Units::sec>
    || std::same_as<T, Units::min>
    || std::same_as<T, Units::hrs>
    || std::same_as<T, Units::days>
    || std::same_as<T, Units::weeks>
    || std::same_as<T, Units::months>;
