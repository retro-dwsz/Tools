...
template void rdt::Vector::Sort<i32>(vec<i32>& v);
template void rdt::Vector::Sort<i64>(vec<i64>& v);
template void rdt::Vector::Sort<f32>(vec<f32>& v);
template void rdt::Vector::Sort<f64>(vec<f64>& v);
