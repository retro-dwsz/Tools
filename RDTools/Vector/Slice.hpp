...
template vec<i32> rdt::Vector::Slice<i32>(const vec<i32>& Data, idx Begin, idx End);
template vec<i64> rdt::Vector::Slice<i64>(const vec<i64>& Data, idx Begin, idx End);
template vec<f32> rdt::Vector::Slice<f32>(const vec<f32>& Data, idx Begin, idx End);
template vec<f64> rdt::Vector::Slice<f64>(const vec<f64>& Data, idx Begin, idx End);

template vec<i32> rdt::Vector::Slice<i32>(const vec<i32>& Data, sidx Index);
template vec<i64> rdt::Vector::Slice<i64>(const vec<i64>& Data, sidx Index);
template vec<f32> rdt::Vector::Slice<f32>(const vec<f32>& Data, sidx Index);
template vec<f64> rdt::Vector::Slice<f64>(const vec<f64>& Data, sidx Index);
