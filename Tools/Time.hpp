...
/* Usage:
 * Begin = Tools::Time::HTimeNow();
 *
 * SomeFunction();
 *
 * End = Tools::Time::HTimeNow();
 *
 * Dur = Tools::Time::CountDuration<Tools::Time::Units::us>(Begin, End);
...
namespace Tools::Time {
    ...
    struct ExecutorReturn {
        topt<Ret> Return;
        str Unit;   // TODO: Integrate with Tools::Time::Units for automatic unit labeling
